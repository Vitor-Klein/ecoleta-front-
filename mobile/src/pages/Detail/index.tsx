  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      <View style={styles.container}>       
          ...
          <TouchableOpacity style={styles.deleteButton} onPress={() => handleDeletePoint} >
          <Icon name="trash-2" size={20} color="#e02041" />
            <Text style={styles.textDelete}>Delete Point</Text>
          </TouchableOpacity>
